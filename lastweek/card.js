...
document.addEventListener("DOMContentLoaded", () => {
  const start = async() => {
    ...
    const avatar = await loadGLTF("https://raw.githubusercontent.com/AR-js-org/AR.js/master/aframe/examples/image-tracking/nft/trex/scene.gltf");
	...
	if (o.userData.clickable) {
	  if (o === leftIcon || o === rightIcon) {
	    ...
	    textObj.visible = true;
	    textElement.innerHTML = "https://www.researchgate.net/profile/Serhiy-Semerikov";
